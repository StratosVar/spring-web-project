	...
	<div class="col-md-4 sidenav">
		<form action="/usersResults" method="get" autocomplete="on">
			...
			<div class="form-group">
				<label for="keyword">KEYWORD SEARCH</label> <input type="search" class="form-control" name="keyword" id="keyword">
			</div>
...
<nav aria-label="Page navigation" class="text-center">
	<ul class="pagination ">
		<li><a href="${requestScope['javax.servlet.forward.request_uri']}?&category=${param.category}&keyword=${param.keywork}&star=${param.star}&size=${param.size}&pages=0&sort=${param.sort} " aria-label="Previous"> <span
		...
		<li><a href="${requestScope['javax.servlet.forward.request_uri']}?&category=${param.category}&keyword=${param.keywork}&star=${param.star}&page=${total-1}&size=${param.size}&sort=${param.sort} ">${total}</a></li>
	</c:forEach>

	
	<li><a href="${requestScope['javax.servlet.forward.request_uri']}?&page=${totalpages-1}&size=${param.size}&category=${param.category}&keyword=${param.keywork}&star=${param.star}&sort=${param.sort}" aria-label="Next"> <span aria-hidden="true">&raquo;</span> 
	</a></li>
</ul>
</nav>
